...
public class MainActivity extends BaseActivity implements FragmentListener,
    ...
    private void setupMenuBottomBar(AppCompatDialog dialog) {
        ...
        chromeViewModel.isCurrentTabInBookmark().observe(this, bottomBarItemAdapter::setBookmark);
    }
    ...
    private void onBookMarkClicked() {
        ...
        Boolean isActivated = chromeViewModel.isCurrentTabInBookmark().getValue();
